...
class Trei_OPT:
    ...
    def schimburi(self, f, i, j, k , modificare):
        # 3 opt inseamna ca se pot face 2 schimburi si 3 schimburi rezultand 7 cicluri
        # 3 - 1 modificare de tipul 2-schimburi si
        # 3 - 2 modificari de tipul 2 schimburi
        # 1 - 3 modificari de tipul 2 schimburi
    ...
    def opt(self, algoritm_determinare_ciclu):
        ...
        solutii_intermediare.append([copy.deepcopy(f), round(solutie, 4), 0, 0, 0])
        ...
        while True:
            ...
            if len(solutii_intermediare) == 1:
                print("dhfjds", solutii_intermediare)
                solutii_intermediare.append([copy.deepcopy(f), round(solutie, 4), poz_i, poz_j, poz_k])
    ...
    def TSP(self, repetari, algoritm_determinare_ciclu):
        ...
        for _ in range(repetari):
            ciclu, solutie, intermediare_retinute = self.opt(algoritm_determinare_ciclu)
            if solutie < solutie_minima:
                solutie_minima = solutie
                ciclu_solutie_minima = ciclu
                pasi = intermediare_retinute
                
        print("steps", intermediare_retinute)
        return round(solutie_minima, 4), ciclu_solutie_minima, pasi